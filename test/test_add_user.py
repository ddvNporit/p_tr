...
def test_add_user(app):
    ...
    app.user.add()
    app.user.fill(UserfieldsName(firstname="1 test add Петров", middlename="test add Иван", lastname="777 test add Иванович", nickname="кличка", \

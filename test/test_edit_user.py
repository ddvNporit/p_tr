...
def test_edit_user(app):
    ...
    app.user.modify_first_user(UserfieldsName(firstname="956 test edit Иванов", middlename="test edit Джан", lastname="956 test edit Иныч", nickname="test edit  фунт", \
